...
export default function Create({ auth, categories }: Props) {
    ...
    const submit: FormEventHandler = (e) => {
        ...
        post('/admin/papercrafts', {
            ...
            onError: () => {
                showToast(
                    'Validasi Gagal! Periksa form isian berwarna merah.',
                    'error',
                );
            },
        });
                    ...
                    >
                        <div className="border-b border-gray-800 pb-6">
                            ...
                            <p className="text-sm font-semibold text-gray-400">
                                Isi detail papercraft yang akan ditambahkan.
                            </p>
                        </div>
                        ...
                        <div className="border-b border-gray-800 pt-6 pb-6">
                            ...
                            <p className="text-sm font-semibold text-gray-400">
                                Upload file template dan gambar galeri produk.
                            </p>
                        </div>
                        ...
                        <div className="relative overflow-hidden rounded-3xl border border-gray-800 bg-gray-800/50 p-6 shadow-inner sm:p-8">
                            ...
                            <p className="relative z-10 mt-3 flex items-center gap-2 text-xs font-bold text-gray-500">
                                <svg
                                    className="h-4 w-4"
                                    fill="none"
                                    stroke="currentColor"
                            ...
                            {errors.template_file && (
                                <p className="relative z-10 mt-2 text-xs font-bold text-red-400">
                                    {errors.template_file}
                                </p>
                            )}
                        </div>
                        ...
                        <div>
                            ...
                            <div
                                className={`mt-1 flex justify-center rounded-3xl border-2 border-dashed bg-gray-900/50 px-6 py-10 transition-all ${errors.images ? 'border-red-500 bg-red-900/20' : 'border-gray-700 hover:border-gray-500 hover:bg-gray-800'}`}
                            >
                                <div className="space-y-3 text-center">
                                    ...
                                    <p className="mt-2 text-xs font-bold text-gray-500">
                                        PNG, JPG, JPEG up to 2MB. (Gambar
                                        pertama akan jadi thumbnail)
                                    </p>
                                </div>
                            </div>
                            {errors.images && (
                                <p className="mt-3 rounded-xl border border-red-800/50 bg-red-900/30 p-3 text-xs font-bold text-red-400">
                                    {errors.images}
                                </p>
                            )}
                                    ...
                                    <ul className="space-y-2">
                                        {data.images.map((file, idx) => (
                                            ...
                                            >
                                                ...
                                                {idx === 0 && (
                                                    <span className="rounded-lg bg-gray-600 px-3 py-1 text-xs font-black whitespace-nowrap text-white shadow-sm">
                                                        Primary Thumbnail
                                                    </span>
                                                )}
                                            </li>
