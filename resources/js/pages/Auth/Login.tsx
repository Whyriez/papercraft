    ...
    return (
        ...
        >
            ...
            <div className="pointer-events-none absolute inset-0 opacity-40">
                <div className="absolute -top-24 -right-24 h-96 w-96 rounded-full bg-gray-700/30 blur-3xl" />
            ...
            <div className="relative z-10 w-full max-w-md">
                ...
                <div className="relative rounded-[38px] border border-gray-800 bg-gray-900 p-8 shadow-xl sm:p-12">
                    <div className="mb-10 text-center">
                        ...
                        >
                            <div className="flex h-16 w-16 items-center justify-center overflow-hidden rounded-3xl border border-gray-700 bg-gray-800 text-gray-200 shadow-sm ring-4 ring-gray-900 ring-offset-2 ring-offset-gray-800 transition-transform hover:scale-105">
                                <img
                                    src="/logo.png"
                                    alt="PaperCraft Logo"
                        ...
                        <h2 className="mt-6 text-3xl font-black tracking-tight text-gray-100">
                            Admin Portal
                        </h2>
                        <p className="mt-3 text-sm leading-relaxed font-semibold text-gray-400">
                            Masuk ke dashboard untuk mengelola koleksi
                            papercraft Anda.
                        </p>
                    </div>
                    ...
                    <form onSubmit={submit} className="space-y-6">
                        <div>
                            <label
                                htmlFor="email"
                                className="block text-xs font-bold tracking-[0.2em] text-gray-400 uppercase"
                            >
                                Email Address
                            </label>
                            <input
                                ...
                                className={`mt-3 block w-full rounded-2xl border bg-gray-800 px-5 py-4 text-sm font-semibold text-gray-200 shadow-inner transition-all placeholder:font-medium placeholder:text-gray-500 focus:ring-2 focus:outline-none ${
                                    errors.email
                        ...
                        <div className="flex items-center justify-between">
                            <label className="group flex cursor-pointer items-center gap-3">
                                <div className="relative flex h-5 w-5 items-center justify-center rounded border border-gray-700 bg-gray-800 transition-colors group-hover:border-gray-500">
                                    ...
                                    />
                                    <svg
                                        className="h-3.5 w-3.5 text-gray-300 opacity-0 transition-opacity peer-checked:opacity-100"
                                        fill="none"
                                        viewBox="0 0 24 24"
                                        stroke="currentColor"
                                        strokeWidth={3}
                        ...
                        <div className="pt-2">
                            <button
                                type="submit"
                                disabled={processing}
                                className="flex w-full items-center justify-center rounded-full bg-gray-200 px-6 py-4 text-sm font-bold text-gray-900 shadow-md transition-all hover:-translate-y-0.5 hover:bg-white focus:ring-4 focus:ring-gray-200/30 focus:outline-none disabled:opacity-50 disabled:hover:translate-y-0"
                            >
                                {processing
                                    ? 'Memproses...'
                                    : 'Masuk ke Dashboard'}
            ...
            <div className="absolute top-10 right-10 hidden opacity-60 md:block">
                <div className="h-20 w-20 rotate-12 rounded-[24px] bg-gray-800 shadow-lg ring-1 ring-gray-700" />
            </div>
            <div className="absolute bottom-10 left-10 hidden opacity-60 md:block">
