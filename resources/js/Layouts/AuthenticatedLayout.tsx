...
export default function AuthenticatedLayout({
    ...
    return (
        ...
        >
            {/* Sidebar (Desktop) */}
            <aside className="z-30 hidden w-72 shrink-0 flex-col border-r border-gray-800 bg-gray-950/80 shadow-lg backdrop-blur-md md:flex">
                <div className="flex h-20 shrink-0 items-center border-b border-gray-800 px-8">
                    <Link href="/" className="flex items-center gap-3">
                        <div className="flex h-10 w-10 items-center justify-center overflow-hidden rounded-xl border border-gray-700 bg-gray-800 text-gray-200 shadow-sm ring-2 ring-gray-900">
                            <img
                                src="/logo.png"
                                alt="PaperCraft Logo"
                ...
                <div className="flex-1 scrollbar-thin scrollbar-thumb-gray-700 space-y-2 overflow-y-auto px-6 py-8">
                    <div className="mb-4 px-2 text-[10px] font-bold tracking-[0.25em] text-gray-500 uppercase">
                        Menu Utama
                    </div>
                ...
                <div className="shrink-0 border-t border-gray-800 bg-gray-900/30 p-6">
                    <div className="flex items-center gap-4 rounded-2xl border border-gray-800 bg-gray-900 p-3 shadow-sm">
                        <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border border-gray-700 bg-gray-800 font-black text-gray-300">
                            {user.name.charAt(0)}
                        </div>
            ...
            <div className="flex flex-1 flex-col overflow-hidden">
                {/* Header Utama (Topbar) */}
                <header className="z-20 flex h-20 shrink-0 items-center justify-between border-b border-gray-800 bg-gray-950/90 px-4 shadow-sm backdrop-blur-md sm:px-8">
                    {/* Tombol Mobile Menu */}
                    <button
                    ...
                    <div className="flex items-center gap-5">
                        ...
                        <Link
                            ...
                            method="post"
                            as="button"
                            className="rounded-full border border-gray-700 bg-gray-800 px-4 py-2 text-xs font-bold tracking-[0.15em] text-gray-300 uppercase shadow-sm transition-all hover:-translate-y-0.5 hover:bg-gray-700 hover:text-white"
                        >
                            Log Out
                        </Link>
                    </div>
                ...
                {isMobileMenuOpen && (
                    ...
                    >
                        <div
                            className="fixed inset-y-0 left-0 w-72 bg-gray-950 p-6 shadow-xl"
