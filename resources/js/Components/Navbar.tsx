            ...
            <div className="mx-auto flex max-w-7xl flex-col gap-0 rounded-[34px] border border-gray-800 bg-gray-900/95 px-5 py-3 shadow-lg shadow-black/20 backdrop-blur-sm transition-all duration-300 sm:py-4">
                <div className="flex items-center justify-between gap-4 sm:gap-6">
                    ...
                    <form
                        ...
                        className="hidden max-w-lg flex-1 items-center gap-3 rounded-full border border-gray-700 bg-gray-800 px-5 py-2.5 shadow-inner transition-all focus-within:border-gray-500 focus-within:ring-1 focus-within:ring-gray-500 lg:flex"
                    >
                        <svg
                    ...
                    <div className="flex shrink-0 items-center gap-3 lg:hidden">
                        <button
                            type="button"
                            className="flex h-10 w-10 items-center justify-center rounded-full border border-gray-700 bg-gray-800 text-gray-300 shadow-sm transition-all hover:-translate-y-0.5 hover:bg-gray-700 hover:text-white sm:h-11 sm:w-11"
                            onClick={() =>
                ...
                {isMobileMenuOpen && (
                    <div className="mt-4 flex flex-col gap-2 border-t border-gray-700 pt-4 pb-2 text-sm font-semibold text-gray-300 lg:hidden">
                        ...
                        <form
                            onSubmit={handleSearch}
                            className="mb-2 flex items-center gap-3 rounded-2xl border border-gray-700 bg-gray-800 px-4 py-3 shadow-inner focus-within:border-gray-500 focus-within:ring-1 focus-within:ring-gray-500"
                        >
                            <svg
                        ...
                        <Link
                            ...
                            className="rounded-2xl px-5 py-3 transition-colors hover:bg-gray-800 hover:text-white"
                        >
                            Home
                        </Link>
